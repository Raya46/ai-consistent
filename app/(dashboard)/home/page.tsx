	...
	return (
		<div className="min-h-screen bg-linear-to-b from-white via-white to-blue-200 flex flex-col items-center justify-center p-4">
			<div className="text-center max-w-3xl mb-8">
				<Badge className="py-2 mb-6 px-4 bg-linear-to-r from-blue-700 via-blue-300 to-blue-700 text-white border-0">
			...
			<div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 w-full max-w-6xl px-4 mb-8">
				{features.map((feature) => (
					...
					>
						<div className="h-12 w-12 rounded-lg bg-linear-to-b from-blue-600 to-indigo-400 flex items-center justify-center">
